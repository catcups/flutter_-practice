...
class WebViewState extends State<FlutterWebView> with AutomaticKeepAliveClientMixin {
  ...
  void initState(){
    ...
    print("web url =111= $_webUrl == ${widget.url}");

    // _webUrl = Uri.decodeComponent(widget.url);
    // https://baike.baidu.com/item/动漫新番
    // https://baike.baidu.com/item/动画新番
    // _webUrl = Uri.decodeComponent('https://www.baidu.com');

    print("web url =222= $_webUrl == ${widget.url}");
